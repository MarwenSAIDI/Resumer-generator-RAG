...
async def job_offer_experiences(
    ...
    try:
        ...
        logger.info(
            f"generator_route - Extracted experiences {time_elapsed} seconds."
        )
...
async def generate_resumer(
    ...
    Args:
        ...
        education (Education): _description_
        retrievedExperiences (RetrievedExperience): _description_
        jobOfferDetails (JobOfferDetails): _description_

    Raises:
        UnprocessedRequestError: _description_

    Returns:
        Resumer: _description_
    """
